...
static const yytype_int16 yyrline[] =
{
     ...
     313,   320,   325,   332,   351,   373,   379,   414,   420,   435,
     441,   458,   464,   486,   492,   521,   535,   548,   557,   564,
     620,   626,   637,   644,   657,   673,   679,   685,   692
};
#endif
...
#line 626 "1905066.y"
		...
		// ---------------------Code generation---------------------
		genCode("\tMOV AX, " + (yyvsp[0].symbolInfo)->getName());
		genCode("\tPUSH AX");
	}
#line 2215 "y.tab.c"
    break;
